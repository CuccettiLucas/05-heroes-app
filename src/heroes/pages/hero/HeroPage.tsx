          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                <Badge
                  className={`${getCategoryColor(info?.category)} text-white`}
                >
                  {info?.category}
                </Badge>
              ...
              <p className="text-xl text-blue-200 mb-4">{info?.name}</p>
        ...
        <Tabs defaultValue="stats" className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={info?.intelligence && info?.intelligence * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={info?.speed && info?.speed * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={info?.durability && info?.durability * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <Progress
                        value={info && info?.intelligence * 10}
                        className="h-4"
                      />
                    </div>
                    <div className="w-12 text-right font-bold">
                      {info && info?.intelligence}/10
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
          ...
          <TabsContent value="powers">
            <Card>
              ...
              <CardContent>
                {info &&
                  Array.isArray(info.powers) &&
                  info.powers.length > 0 && (
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="font-semibold">{info?.alias}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="font-semibold">{info?.universe}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="font-semibold">
                      {info &&
                        new Date().getFullYear() -
                          Number.parseInt(info?.firstAppearance)}{" "}
                      años
                    </span>
                  </div>
                </CardContent>
